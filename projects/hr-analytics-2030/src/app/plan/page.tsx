    ...
    return (
        <div className="space-y-8 pb-12">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                <h3 className="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-4">{t('plan.title')}</h3>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden print:shadow-none print:border">
                        <table className="w-full text-left text-sm">
                            <thead className="bg-slate-50 border-b border-slate-200">
                                <tr>
                                    <th className="px-6 py-4 font-semibold text-slate-700">{t('plan.dept_breakdown')}</th>
                                    <th className="px-6 py-4 font-semibold text-slate-700 text-right">{t('plan.current_headcount')}</th>
                                    ...
                                    <th className="px-6 py-4 font-semibold text-slate-900 text-right">{t('plan.hiring_gap')}</th>
                                </tr>
                            </thead>
